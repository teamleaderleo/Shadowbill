...
export async function runCommandCli(args) {
  ...
  try {
    ...
    const response = {
      ...
      revisionChanged: result.revisionChanged ?? false,
      runId: result.runId,
      ...
      dirtyWorktreeBefore: result.dirtyBefore ?? null,
      dirtyWorktreeAfter: result.dirtyAfter ?? null,
      postInspectionUnavailable: result.postInspectionUnavailable ?? false,
